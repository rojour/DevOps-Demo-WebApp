  ...
  stages {
    ...
    stage('SanityTest') {
      ...
      post {
        ...
        always {
          slackSend channel: 'alerts', color: 'good', message: "Started - Job Name - ${env.JOB_NAME}, Build# - ${env.BUILD_NUMBER}, (<${env.BUILD_URL}|Open>)", tokenCredentialId: 'slacknotifications', username: 'admin'
        }
        success {
